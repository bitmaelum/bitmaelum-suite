...
func (r *fileRepo) FetchMessageCatalog(addr address.HashAddress, box int, messageID string) ([]byte, error) {
...
func (r *fileRepo) FetchMessageBlock(addr address.HashAddress, box int, messageID, blockID string) ([]byte, error) {
