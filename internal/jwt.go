...
func GenerateJWTToken(addr address.Hash, key bmcrypto.PrivKey) (string, error) {
...
func ValidateJWTToken(tokenString string, addr address.Hash, key bmcrypto.PubKey) (*jwt.Token, error) {
